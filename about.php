...
<head>
	...
	<script>
		...
		function change2() {
  			...
  			document.getElementById("h2text").innerText = "YU-HSUN CHEN";
		}
	</script>
...
<table width="70%" border="1">
	...
	靜宜網頁：<a href="https://www1.pu.edu.tw/~tcyang">https://www.pu.edu.tw/</a><br>
	
	E-Mail: <a href="mailto:leo920810920810@gmail.com">leo920810920810@gmail.com</a><br>
</td>
<td>
...
<table width="70%" border="1">
	<tr>
		<td>
			聊天機器人<br>
			<iframe width="350" height="430" allow="microphone;" src="https://console.dialogflow.com/api-client/demo/embedded/d120b81a-d9b9-45c5-9ee5-f8f9e1f19c7d"></iframe>
		</td>
	</tr>
</table>
